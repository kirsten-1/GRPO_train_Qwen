...
DEFAULT_STAGE1_TRAIN_PATH = "/root/autodl-tmp/training_data/stage1_simple_math_train.json"
...
def combined_stage1_reward(completions: List[List[Dict[str, str]]], solution: List[str], **kwargs: Any) -> List[float]:
    acc = math_accuracy_reward(completions, solution, **kwargs)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--early-stop-gsm-gain", type=float, default=8.0)
